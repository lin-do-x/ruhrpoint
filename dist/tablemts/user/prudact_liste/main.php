...
<div class="cards w-full flex justify-center items-center gap-4 p-5 flex-wrap" id="cards">
        ...
        <div class="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
            ...
            <div class="p-6">
              ...
              <div class="w-2/3 h-[220px] overflow-hidden mx-auto aspect-w-16 aspect-h-8">
                <img src="https://m.media-amazon.com/images/I/81fYvFvX-8L._AC_SL1500_.jpg" alt="Product 1" class="h-full w-full object-contain" />
              </div>
            </div>
...
<script src="js/prudact_liste/fetch.js"></script>
