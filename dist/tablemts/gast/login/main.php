    ...
    <div class="font-[sans-serif] text-[#333] mt-4 p-4 relative">
        <div class="max-w-md w-full mx-auto relative z-10">
          ...
          <div class="border border-gray-300 bg-white rounded-md p-8">
            <form class="w-full" method="POST" id="loginForm">
              <div class="mb-6">
                <h3 class="text-2xl font-extrabold">Log-In</h3>
              </div>
              <div class="space-y-6">
                ...
                <div>
                  ...
                  <p class="error text-sm text-red-600" id="e_error">
                ...
                <div>
                  ...
                  <div class="relative flex items-center">
                    <input name="password" id="password" type="password" required class="bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded outline-blue-500" placeholder="Passwort eingeben" />
                ...
                <p class="error text-sm text-red-600" id="p_error">
                    
                    </p>
                  <p class="error text-sm text-red-600" id="error">
                    
                  </p>
              </div>
              <div class="!mt-10">
                <button type="submit" id="login" class="w-full py-3 px-4 text-sm font-semibold rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                  Einloggen
                </button>
              </div>
              <p class="text-sm mt-6 text-center">Haben Sie noch kein Konto? <a href="register.php" class="text-blue-600 font-semibold hover:underline ml-1">Hier registrieren</a></p>
            </form>
          </div>
        </div>
